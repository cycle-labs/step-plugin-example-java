...
public class ResetCounterSecretStepTest {

    private SuiteContext suiteContext;
    private ScenarioContext scenarioContext;
    private ResetCounterSecretStep step;
    ...
    public void setUp() {
        ...
        step = new ResetCounterSecretStep();
    }
    ...
    public void call() {
        ...
        StepInputsBody rawInputs = new StepInputsBody().putVariablesItem(CounterConstants.SECRET_VARIABLE, 7777);
        ...
        assertEquals("Reset the counter to 7777.", response.getMessage());

        int counter = scenarioContext.getScenarioState().get(CounterConstants.KEY_COUNTER);
        assertEquals(counter, 7777);
    }
}
