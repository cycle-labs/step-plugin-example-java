...
public class IncrementCounterDelayStepTest {

    private SuiteContext suiteContext;
    private ScenarioContext scenarioContext;
    private IncrementCounterDelayStep step;
    ...
    public void setUp() {
        ...
        step = new IncrementCounterDelayStep();
    }
    ...
    public void call() {
        ...
        StepInputsBody rawInputs = new StepInputsBody()
            .putParametersItem("increment", 3)
            .putParametersItem("timeout", 1)
            .putParametersItem("unit", "seconds");
        ...
        assertEquals("Incremented the counter by 3 from 5 to 8 after a delay of 1000 ms.", response.getMessage());
